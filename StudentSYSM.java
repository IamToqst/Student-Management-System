...
public class StudentSYSM {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!menuError.isEmpty()) System.out.println("\u001b[41m\u001B[1m\u001B[37m" + menuError + " \u001B[0m");
            menuError = "";
    ...
    private static void addStudent() {
        ...
        while (addingStudent) {
            ...
            if (!error.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + error + " \u001B[0m"); error = ""; }
            ...
            } else System.out.println("\u001b[47m\u001B[1m Enter student name | ➤ \u001B[0m " + FormState.name);
            ...
            } else System.out.println("\u001b[47m\u001B[1m Enter LRN (numbers only) | ➤ \u001B[0m " + FormState.lrn);
            ...
            } else System.out.println("\u001b[47m\u001B[1m Enter strand | ➤ \u001B[0m " + FormState.strand);

            String confirmError = "", confirm;
            while (true) {
                clearScreen();
                System.out.println(banner + "\n\n\u001b[41m\u001B[1m\u001B[37mPlease confirm student information\u001B[0m\n");
                ...
                if (!confirmError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + confirmError + " \u001B[0m"); confirmError = ""; }
                System.out.print("\u001b[41m\u001B[1m\u001B[37mIs this correct? [Y: confirm | N: refill | X: cancel] | ➤ \u001B[0m ");
            ...
            if (studentFile.exists()) {
                ...
                while (true) {
                    ...
                    System.out.println("\u001b[47m\u001B[1mLRN | ➤ \u001B[0m " + FormState.lrn);
                    System.out.println("\u001b[47m\u001B[1mStrand | ➤ \u001B[0m " + FormState.strand + "\n");
                    if (!overwriteError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + overwriteError + " \u001B[0m"); overwriteError = ""; }
                    System.out.print("\u001b[41m\u001B[1m\u001B[37m[!] Student exists! Overwrite? [Y: yes, replace | N: no, keep existing] | ➤ \u001B[0m ");
            ...
            while (true) {
                clearScreen();
                System.out.println(banner + "\n");
                System.out.println(fileSaved ? "\u001b[47m\u001B[1m\u001B[30m" + saveMessage + "\u001B[0m\n" : "\u001b[41m\u001B[1m\u001B[37m" + saveMessage + "\u001B[0m\n");
                if (!continueAddingError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + continueAddingError + " \u001B[0m"); continueAddingError = ""; }
                System.out.print("\u001b[41m\u001B[1m\u001B[37mAdd another student? [Y: yes, add more | N: no, return to menu] | ➤ \u001B[0m ");
    ...
    private static void viewAllStudents() {
        ...
        if (files == null || files.length == 0) System.out.println("\u001b[43m\u001B[1m\u001B[30mNo students found.\u001B[0m");
    ...
    private static void deleteStudent() {
        ...
        while (deleting) {
            ...
            if (delFiles == null || delFiles.length == 0) {
                System.out.println("\u001b[41m\u001B[1m\u001B[37mNo students found to delete.\u001B[0m");
            ...
            System.out.println();
            if (!deleteError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + deleteError + " \u001B[0m"); deleteError = ""; }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (!confirmError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + confirmError + " \u001B[0m"); confirmError = ""; }
                    System.out.print("\u001b[41m\u001B[1m\u001B[37m[!] Delete " + studentName + "? [Y: yes, delete permanently | N: no, keep student] | ➤ \u001B[0m ");
                    String confirm = sc.nextLine().trim().toUpperCase();
                    if (confirm.equals("Y")) {
                        System.out.println(delFiles[delChoice-1].delete() ? "\u001b[47m\u001B[1m\u001B[30mDeleted " + studentName + "\u001B[0m" : "\u001b[41m\u001B[1m\u001B[37m[!] Could not delete file - check permissions\u001B[0m");
                        break;
                ...
                while (true) {
                    clearScreen();
                    System.out.println(banner + "\n\n\u001b[47m\u001B[1m\u001B[30mDeleted " + studentName + "\u001B[0m\n");
                    if (!continueError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + continueError + " \u001B[0m"); continueError = ""; }
                    System.out.print("\u001b[41m\u001B[1m\u001B[37mDelete another student? [Y: yes, delete more | N: no, return to menu] | ➤ \u001B[0m ");
    ...
    private static void viewStudentData() {
        ...
        while (viewing) {
            ...
            if (viewFiles == null || viewFiles.length == 0) {
                System.out.println("\u001b[43m\u001B[1m\u001B[30mNo students found.\u001B[0m");
            ...
            System.out.println();
            if (!viewError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + viewError + " \u001B[0m"); viewError = ""; }
            System.out.print("\u001b[47m\u001b[30m Enter student number [X: Back] | ➤ \u001B[0m ");
            ...
            try {
                ...
                while (true) {
                    ...
                    catch (Exception e) { System.out.println("\u001b[41m\u001B[1m\u001B[37mError reading file.\u001B[0m"); }
                    System.out.println();
                    if (!continueViewError.isEmpty()) { System.out.println("\u001b[41m\u001B[1m\u001B[37m" + continueViewError + " \u001B[0m"); continueViewError = ""; }
                    System.out.print("\u001b[41m\u001B[1m\u001B[37mView another student? [Y: yes, view more | N: no, return to menu] | ➤ \u001B[0m ");
    ...
    private static void exitProgram() {
        clearScreen();
        System.out.println(banner + "\n\n\u001b[47m\u001B[1m\u001B[30mExiting the program. Goodbye!\u001B[0m");
        System.exit(0);
    }
